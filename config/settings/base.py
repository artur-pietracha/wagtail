...
ROOT_DIR = environ.Path(__file__) - 3  # (wagtail_api/config/settings/base.py - 3 = wagtail_api/)
APPS_DIR = ROOT_DIR.path("wagtail_api")
...
LOCAL_APPS = [
    "wagtail_api.applesignin",
    "wagtail_api.core.apps.CoreConfig",
    "wagtail_api.user.apps.UserConfig",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": ["wagtail_api.core.authentication.Authentication"],
...
# Allauth
SOCIALACCOUNT_ADAPTER = "wagtail_api.core.adapters.SocialAccountAdapter"
...
SOCIAL_AUTH_APPLE_CLIENT_ID = env("SOCIAL_AUTH_APPLE_CLIENT_ID", default="com.karmababys.app")
...
SOCIAL_AUTH_APPLE_TOKEN_VALID_DURATION = env("SOCIAL_AUTH_APPLE_TOKEN_VALID_DURATION", default=180)
